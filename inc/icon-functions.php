 ...
 */
function kindergarten_dropdown_icon_to_menu_link( $title, $item, $args, $depth ) {

	if ( 'top' === $args->theme_location ) {
		foreach ( $item->classes as $value ) {
			if ( 'menu-item-has-children' === $value || 'page_item_has_children' === $value ) {
				$title = $title . kindergarten_get_svg( array( 'icon' => 'angle-down' ) );
			}
		}
	}
...
add_filter( 'nav_menu_item_title', 'kindergarten_dropdown_icon_to_menu_link', 10, 4 );
 ...
 */
function kindergarten_social_links_icons() {
	...
	return apply_filters( 'kindergarten_social_links_icons', $social_links_icons );
}
